...
fin1 = open("../01.well_data/10.new_process_11A_MD_VD_intpl.txt","r")
...
fin3 = open("../01.well_data/06.extract_dentrace_11A.txt","r")
den = np.loadtxt(fin3)
nden = den.shape[0]
...
fout = open("../01.well_data/12.new_process_11A_GBT_whole.txt","w")
#................................
kk = 0
for ii in range(nz):
