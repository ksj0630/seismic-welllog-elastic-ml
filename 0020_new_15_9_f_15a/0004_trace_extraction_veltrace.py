...
fin3 = open("../01.well_data/03.15_15A_match.txt","r")
...
fout = open("../01.well_data/05.extract_vel_15A.bin","wb")
extrs.tofile(fout)

extrt[:,2] = extrt[:,2]*0.001
np.savetxt("../01.well_data/05.extract_veltrace_15A.txt",extrt,fmt='%f')
