...
fin1 = open("../01.well_data/10.new_process_15A_MD_VD_intpl.txt","r")
well = np.loadtxt(fin1)
nwell = well.shape[0]

well[:,0] = well[:,0]*0.001

fin2 = open("../01.well_data/05.extract_veltrace_15A.txt","r")
vel = np.loadtxt(fin2)
nvel = vel.shape[0]

fin3 = open("../01.well_data/06.extract_dentrace_15A.txt","r")
den = np.loadtxt(fin3)
nden = den.shape[0]

fin4 = open("../01.well_data/04.extract_trace_15A.txt","r")
seis = np.loadtxt(fin4)
nseis = seis.shape[0]

fin5 = open("../01.well_data/11.masking_round_15A.txt","r")
...
fout = open("../01.well_data/12.new_process_15A_GBT_whole.txt","w")
#................................
kk = 0
for ii in range(nz):
