...
fin = open("../01.well_data/08.new_process_F15A.txt","r")
data = np.loadtxt(fin)
...
fout = open("../01.well_data/09.new_process_F15A_mvavg.txt","w")
#................................
kk=0
for ii in range(0,lenxx):
    ...
    fout.write("%f %f %f \n" %(mvavgdata[kk,0], mvavgdata[kk,1], mvavgdata[kk,2]))
