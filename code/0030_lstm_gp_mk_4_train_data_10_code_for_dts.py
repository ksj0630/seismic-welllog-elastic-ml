...
# Load_data
#################################
fin1 = open("../../01.train_data_seismic_1m_mvavg_20_add_masking/12.new_15_9_F_4/01.well_data/20_5.new_process_4_GBT_whole.txt","r")
...
fin3 = open("../05.result/10.code/23.F4_pred.txt","r")
...
np.savetxt("../34.LSTM_GP_train_data_for_DTS/02.4_for_dts.txt", xx, fmt='%.6f', delimiter='      ')