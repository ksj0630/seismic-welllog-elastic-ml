...
# save_model
#################################
save_dir = os.path.join('../06.model_save_folder/131.code/')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

output_dir = os.path.join("../05.result/131.code/")
...
# Load_data
#################################
fin1 = open("../21.GBT_merge_data_from_20.folder/00.merge_data_1A_5_11T2_14_15A.txt","r")
...
fin2 = open("../20.GBT_train_data_for_density/02.4_for_density.txt","r")
...
plt.legend()
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '131.merge_code.png'))
...
plt.figure(figsize=(20, 2))
plt.plot(tvd2[20:-20], y_test[20:-20], label="True", linewidth=1.0, linestyle='solid', color="black")
plt.plot(tvd2[20:-20], predict_test[20:-20], label="Pred", linewidth=1.0, linestyle='solid', color="red")
plt.legend()
...
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '131.code_300.png'))
