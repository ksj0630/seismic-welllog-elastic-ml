...
# save_dir
#################################
save_dir = os.path.join('../06.model_save_folder/123.code/')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

output_dir = os.path.join("../05.result/123.code/")
...
plt.legend()
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '123.merge_code.png'))
...
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '123.code.png'))
