...
# save_dir
#################################
save_dir = os.path.join('../06.model_save_folder/124.code/')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

output_dir = os.path.join("../05.result/124.code/")
...
fin2 = open("../01.GBT_whole_data/12.new_process_15A_GBT_whole.txt", "r")
...
plt.legend()
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '124.merge_code.png'))
...
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '124.code.png'))
