...
# save_model
#################################
save_dir = os.path.join('../06.model_save_folder/87.code/') 
if not os.path.exists(save_dir):
    os.mkdir(save_dir)

output_dir = os.path.join("../05.result/87.code/")
...
def main(n_ch=3, epochs=835, batch_size=128, structure='CNN1D'):
    ...
    plt.grid(linestyle=':')
    # plt.show()
    plt.savefig(os.path.join(output_dir, '87.merge_pred.png'))
    ...
    plt.grid(linestyle=':')
    # plt.show()
    plt.savefig(os.path.join(output_dir, '87.pred.png'))
    ...
    np.savetxt(os.path.join(output_dir, "87.pred_dtc.txt"), pred_dtc, delimiter=' ')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-epochs', type=int, default=835, help='training epochs (default: 300)')
