...
# save_dir
#################################
save_dir = os.path.join('../06.model_save_folder/122.code/')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)

output_dir = os.path.join("../05.result/122.code/")
...
plt.legend()
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '122.merge_code.png'))
...
plt.grid(linestyle=':')
plt.savefig(os.path.join(output_dir, '122.code.png'))
