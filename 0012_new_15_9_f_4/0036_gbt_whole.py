...
fin1 = open("../01.well_data/19_5.new_process_4_MD_VD_intpl.txt","r")
well = np.loadtxt(fin1)
nwell = well.shape[0]

well[:,0] = well[:,0]*0.001

fin2 = open("../01.well_data/24.extract_low_dtstrace_4.txt","r")
...
fout = open("../01.well_data/25_5.lowdts_new_process_4_GBT_whole.txt","w")
#................................
kk = 0
for ii in range(nz):
