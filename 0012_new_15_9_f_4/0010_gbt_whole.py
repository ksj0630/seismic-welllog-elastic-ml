...
fin1 = open("../01.well_data/10.new_process_4_MD_VD_intpl.txt","r")
...
fin3 = open("../01.well_data/06.extract_dentrace_4.txt","r")
den = np.loadtxt(fin3)
nden = den.shape[0]

fin4 = open("../01.well_data/04.extract_trace_4.txt","r")
seis = np.loadtxt(fin4)
nseis = seis.shape[0]

fin5 = open("../01.well_data/11.masking_round_4.txt","r")
...
fout = open("../01.well_data/12.new_process_4_GBT_whole.txt","w")
#................................
kk = 0
for ii in range(nz):
    if(vel[ii,1]>=well[0,1]):
        gbtdata[kk,0] = seis[ii,1]*0.001 # m -> km 단위 변환
