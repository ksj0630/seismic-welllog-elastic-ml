...
fin1 = open("../01.well_data/19_4.new_process_4_MD_VD_intpl.txt","r")
...
fin3 = open("../01.well_data/23.extract_dentrace_4.txt","r")
den = np.loadtxt(fin3)
nden = den.shape[0]
...
fout = open("../01.well_data/20_4.new_process_4_GBT_whole.txt","w")
#................................
kk = 0
for ii in range(nz):
