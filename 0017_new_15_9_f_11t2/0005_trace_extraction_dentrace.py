...
fin1 = open('../../01.seismic_velocity_equal_size/coord_Den_gardner_4500.bin',"rb")
...
fout = open("../01.well_data/06.extract_den_11T2.bin","wb")
extrs.tofile(fout)

extrt[:,2] = extrt[:,2]*0.001
np.savetxt("../01.well_data/06.extract_dentrace_11T2.txt",extrt,fmt='%f')
