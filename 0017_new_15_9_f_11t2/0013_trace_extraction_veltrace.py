...
fin1 = open('../../25.estimation_3d_cube/DTC_sm5_4500_pad_cube.bin',"rb")
...
fout = open("../01.well_data/22.extract_vel_11T2.bin","wb")
extrs.tofile(fout)

# extrt[:,2] = extrt[:,2]*0.001
np.savetxt("../01.well_data/22.extract_veltrace_11T2.txt",extrt,fmt='%f')
