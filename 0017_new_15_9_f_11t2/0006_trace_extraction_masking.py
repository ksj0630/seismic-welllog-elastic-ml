...
fin1 = open('../../00.Horizon_masking/02.masking_padding/cat_masking_unisam2_4500.bin',"rb")
...
fout = open("../01.well_data/07.extract_mask_11T2.bin","wb")
extrs.tofile(fout)

# extrt[:,2] = extrt[:,2]*0.001
np.savetxt("../01.well_data/07.extract_mask_11T2.txt",extrt,fmt='%f')
