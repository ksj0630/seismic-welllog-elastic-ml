...
fin1 = open('../../25.estimation_3d_cube/RHOB_sm5_4500_pad_cube.bin',"rb")
...
fout = open("../01.well_data/23.extract_den_11T2.bin","wb")
extrs.tofile(fout)

# extrt[:,2] = extrt[:,2]*0.001
np.savetxt("../01.well_data/23.extract_dentrace_11T2.txt",extrt,fmt='%f')
