...
fin1 = open("../01.well_data/10.new_process_1B_MD_VD_intpl.txt","r")
well = np.loadtxt(fin1)
nwell = well.shape[0]

well[:,0] = well[:,0]*0.001

fin2 = open("../01.well_data/05.extract_veltrace_1B.txt","r")
vel = np.loadtxt(fin2)
nvel = vel.shape[0]

fin3 = open("../01.well_data/06.extract_dentrace_1B.txt","r")
den = np.loadtxt(fin3)
nden = den.shape[0]
...
fout = open("../01.well_data/12.new_process_1B_GBT_whole.txt","w")
#................................
kk = 0
for ii in range(nz):
